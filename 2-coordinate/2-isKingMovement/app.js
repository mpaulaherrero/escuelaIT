const {coordinateIsKingMovement} = require("./coordinateIsKingMovement");
...
console.writeln(coordinateIsKingMovement(abscissaOrigin, ordinateOrigin, abscissaDestiny, ordinateDestiny));