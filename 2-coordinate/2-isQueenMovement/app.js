const {coordinateIsQueenMovement} = require("./coordinateIsQueenMovement");
...
console.writeln(coordinateIsQueenMovement(abscissaOrigin, ordinateOrigin, abscissaDestiny, ordinateDestiny));