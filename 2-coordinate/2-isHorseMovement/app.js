const {coordinateIsHorseMovement} = require("./coordinateIsHorseMovement");
...
console.writeln(coordinateIsHorseMovement(abscissaOrigin, ordinateOrigin, abscissaDestiny, ordinateDestiny));